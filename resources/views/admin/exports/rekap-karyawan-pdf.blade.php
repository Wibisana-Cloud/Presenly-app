...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .stat-box { flex: 1; border-radius: 10px; padding: 12px 14px; text-align: center; }
...
<div class="employee-box">
    ...
    <div class="emp-row">
        ...
        <span class="emp-value">{{ $user->departemen->nama }}</span>
    </div>
    @endif
    <div class="emp-row">
    ...
    <div class="emp-row">
        <span class="emp-label">Total Hari Tercatat</span>
        <span class="emp-value">{{ $absensi->count() }} hari</span>
    </div>
</div>
